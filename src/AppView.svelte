    ...
    function defineGuestLayout()
    {
        return {
                ...
                mainToolbar : {
                    customOperations:[
                        {
                        //    caption: '_; Leave guest session; Salir de la sesi�n de invitado; Opu�� sesj� go�cia',
                            captionFunc: () => '_; Leave guest session; Salir de la sesi�n de invitado; Opu�� sesj� go�cia',
                            icon: FaSignOutAlt,
                            action: (f) => {
