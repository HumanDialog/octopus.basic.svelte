    ...
    <section class="">
        <div class="relative max-w-5xl mx-auto pt-20 sm:pt-24 lg:pt-32">
            <h1
                ...
                _; Page not found; Página no encontrada; Nie znaleziono strony
            </h1>
            <p class="mt-6 text-lg text-slate-600 text-center max-w-3xl mx-auto ">
                _;
                Oops, looks like you've reached beyond the edges of our website. 
                Vaya, parece que has salido de los límites de nuestro sitio web.;
                Ups, wygląda na to, że przekroczyłeś granice naszej strony internetowej.
            </p>
            <div class="mt-6 sm:mt-10 flex justify-center space-x-6 text-sm">
                <button class="bg-slate-900 hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 text-white font-semibold h-12 px-6 rounded-lg w-full flex items-center justify-center sm:w-auto dark:bg-sky-500 dark:highlight-white/20 dark:hover:bg-sky-400"
                    on:click={() => {pop()}}>_; Back; Volver; Wróć</button></div>
        </div>
